...
AttributeTableEditorForm::AttributeTableEditorForm(QList<uint8_t> palette, IProjectTreeViewItem* link,
                                                   QWidget* parent) :
	...
	ui(new Ui::AttributeTableEditorForm)
{
	...
	{
		m_colors.at(idx)->setCurrentColor(QColor(nesGetPaletteRedComponent(m_palette.at(idx)),
		                                         nesGetPaletteGreenComponent(m_palette.at(idx)),
		                                         nesGetPaletteBlueComponent(m_palette.at(idx))));
