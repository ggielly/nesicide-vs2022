...
void CROMMapper009::RESET (const bool soft )
{
...
uint32_t CROMMapper009::DEBUGINFO (const uint32_t addr )
{
   switch ( addr&0xF000 )
   {
      case 0xA000:
...
void CROMMapper009::HMAPPER (const uint32_t addr, const uint8_t data )
{
   int32_t reg = 0;
...
void CROMMapper009::SYNCPPU ( uint32_t ppuCycle, const uint32_t ppuAddr )
{
