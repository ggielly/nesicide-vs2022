...
void CROMMapper065::RESET (const bool soft )
{
   m_mapper = 65;
...
uint32_t CROMMapper065::DEBUGINFO (const uint32_t addr )
{
   switch ( addr )
   {
      case 0x8000:
...
void CROMMapper065::HMAPPER (const uint32_t addr, const uint8_t data )
{
   switch ( addr )
   {
      case 0x8000:
