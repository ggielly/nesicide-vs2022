...
public:
   ...
   void GOTO (const uint32_t pcGoto )
   {
      m_pcGoto = pcGoto;
   }
   void GOTO ()
   ...
   void _N (const uint32_t set )
   {
      m_f&=~(FLAG_N);
      m_f|=((!!set)<<FLAG_N_SHIFT);
   }
   void _V (const uint32_t set )
   {
      m_f&=~(FLAG_V);
      m_f|=((!!set)<<FLAG_V_SHIFT);
   }
   void _B (const uint32_t set )
   {
      m_f&=~(FLAG_B);
      m_f|=((!!set)<<FLAG_B_SHIFT);
   }
   void _D (const uint32_t set )
   {
      m_f&=~(FLAG_D);
      m_f|=((!!set)<<FLAG_D_SHIFT);
   }
   void _I (const uint32_t set )
   {
      m_f&=~(FLAG_I);
      m_f|=((!!set)<<FLAG_I_SHIFT);
   }
   void _Z (const uint32_t set )
   {
      m_f&=~(FLAG_Z);
      m_f|=((!!set)<<FLAG_Z_SHIFT);
   }
   void _C (const uint32_t set )
   {
      m_f&=~(FLAG_C);
   ...
   void BREAKONKIL(const bool breakOnKIL)
   {
   ...
   // disassembler.
   inline void OPCODEMASK (const uint32_t addr, const uint8_t mask )
   {
   ...
   inline const char* DISASSEMBLY (const uint32_t addr )
   {
   ...
   uint16_t ADDR2SLOC (const uint32_t addr )
   {
