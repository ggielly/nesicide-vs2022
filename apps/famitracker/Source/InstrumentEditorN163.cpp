...
void CInstrumentEditorN163::SelectInstrument(const int Instrument)
{
...
void CInstrumentEditorN163::SelectSequence(const int Sequence, const int Type)
{
...
void CInstrumentEditorN163::TranslateMML(CString String, const int Max, const int Min)
{
...
void CInstrumentEditorN163::SetSequenceString(const CString Sequence, const bool Changed)
{
