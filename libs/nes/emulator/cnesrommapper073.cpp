...
void CROMMapper073::RESET (const bool soft )
{
   m_mapper = 73;
...
uint32_t CROMMapper073::DEBUGINFO (const uint32_t addr )
{
   switch ( addr )
   {
   case 0x8000:
...
void CROMMapper073::HMAPPER (const uint32_t addr, const uint8_t data )
{
   uint32_t reg = 0;
