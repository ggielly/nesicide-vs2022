...
int main(int argc, char* argv[])
{
	...
	auto splash = new StartupSplashDialog();
	//splash->exec();
	delete splash;
	...
	QObject::connect(&nesicideEventFilter,SIGNAL(applicationActivationChanged(bool)), nesicideWindow,
	                 SLOT(applicationActivationChanged(bool)));
	nesicideWindow->show();
