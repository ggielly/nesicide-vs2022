...
public:
	...
	void setModified(bool modified) override { m_scintilla->setModified(modified); }
...
public slots:
	...
	void replaceText(QString from, QString to, bool replaceAll) override;
	void setBreakpoint(int line, int addr, int absAddr);
	void updateTargetMachine(QString target);
	void checkOpenFile(QDateTime lastActivationTime) override;
	void editor_undo();
	void editor_redo();
	void editor_cut();
	void editor_copy();
	...
	void applyAppSettingsToTab() override;
};
