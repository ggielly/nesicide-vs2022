	...
	if (m_memDB)
	{
		if (role == Qt::BackgroundRole)
		{
			return QBrush(QColor(
				m_memDB->GetCellRedComponent(m_memDB->Get((index.row() * m_memDB->GetNumColumns()) + index.column())),
				m_memDB->GetCellGreenComponent(m_memDB->Get((index.row() * m_memDB->GetNumColumns()) + index.column())),
				m_memDB->GetCellBlueComponent(
					m_memDB->Get((index.row() * m_memDB->GetNumColumns()) + index.column()))));
		}
